    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratacion', models.ForeignKey(to='main.Contratacion')),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('planes', models.ManyToManyField(to='main.Plan', through='main.Contratacion')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='contratacion',
            name='socio',
            field=models.ForeignKey(to='main.Socio'),
        ),
    ]
